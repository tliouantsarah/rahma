...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM dentistes WHERE nom_utilisateur = '$nom_utilisateur' AND mot_de_passe = '$mot_de_passe'";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        $_SESSION['dentiste'] = $nom_utilisateur;
        header("Location: dentiste_dashboard.php");
        exit();
    } else {
